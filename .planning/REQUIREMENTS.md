...
- [ ] **EDIT-01**: User can write and edit HTML in a code editor with syntax highlighting
- [ ] **EDIT-02**: User can paste HTML into the editor without content being mangled or reformatted
...
- [ ] **UX-01**: User can see all client previews side-by-side in a parallel layout
